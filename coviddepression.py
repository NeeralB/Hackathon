...
import time
counter = 0
sadwords = ["depression", "mental", "pain", "trash", "gay", "shit", "fuck", "black", "stressed", "die", "stress"]
...
if counter > 0:
    ...
    if slope < 10 and slope > 0:
        print("You seem extremely depressed, and most definetly need to learn yoga.")
    elif slope <30 and slope >10:
        print("You seem quite depressed. You may need to learn to take classes on how to control yourself")
    elif slope <50 and slope >30:
        print("You seem are VERY VERY DEPRESSED")
    else:  
...
def main():
    _str = texttosearch
    my_list = ['depression', 'mental', 'pain', 'trash', 'gay', 'shit', 'fuck', 'black', 'stressed', 'die', 'stress', 'suicide', 'dark', 'elephant', 'sad']
    counts = {}
    for i in my_list:
...
import matplotlib.pyplot as plt
barx = ["depression", "mental", "pain", "trash", "gay", "shit", "fuck", "black", "stressed", "die", "stress"]
